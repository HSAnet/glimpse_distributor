...
DAEMON_ARGS="distributor.wsgi:application --daemon --proxy-allow-from '127.0.0.1' --umask 0000 --user $RUNAS_USER --group $RUNAS_USER --socket unix:$SOCKETFILE --pid $PIDFILE";
